...
function App() {
  ...
  return (
    <>
      ...
      <div style={{width:'200px', height:'400px', backgroundColor:'black', margin:'auto', marginBottom:'20px' }}>
          <div style={{
            width: '120px',
            height:'120px',
            borderRadius:'50%',
      ...
      <div style={{width:'200px',height:'100px',backgroundColor:'green',fontSize:'50px', textAlign:'center',
                  margin:'auto',marginBottom:'20px' ,paddingTop:'25px', cursor:'pointer' }} onClick={handleClick}>Click</div>    
    </>
